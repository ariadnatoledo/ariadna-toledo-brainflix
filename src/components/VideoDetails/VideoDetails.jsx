...
function VideoDetails({ videoDetails, comments }) {
  return (
    <>
      {/* Video Details */}
      {videoDetails.title && (
        <div className="videodetails">
          ...
          <div className="videodetails__container">
            <div className="videodetails__channel">
              <p className="videodetails__channel-name">
                <strong>By:</strong> {videoDetails.channel}
              </p>
            ...
            <div className="videodetails__section">
              <div className="videodetails__container-views">
                ...
                />
                <p className="videodetails__sections-views">
                  {videoDetails.views}
                </p>
              </div>
              <div className="videodetails__container-likes">
                <img
                  ...
                  className="videodetails__section-icon"
                />
                <p className="videodetails__section-likes">
                  {videoDetails.likes}
                </p>
              </div>
            </div>
